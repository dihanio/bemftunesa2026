...
export const Select = ({ children, ...props }: React.HTMLAttributes<HTMLElement> & { value?: string, onValueChange?: (v: string) => void }) => <div {...props}>{children}</div>;
...
export const SelectItem = ({ children, ...props }: React.HTMLAttributes<HTMLElement> & { value?: string, onValueChange?: (v: string) => void }) => <div {...props}>{children}</div>;
