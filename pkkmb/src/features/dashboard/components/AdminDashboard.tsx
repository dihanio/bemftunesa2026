...
export function AdminDashboard() {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Banner */}
      <div className="glass-subtle rounded-2xl p-6 border border-red-500/10 bg-gradient-to-tr from-red-500/10 to-amber-500/10">
        <div className="flex items-center gap-4">
          <div className="h-16 w-16 rounded-2xl bg-gradient-to-tr from-red-500 to-amber-500 flex items-center justify-center text-white text-2xl font-bold">
            {user.name ? user.name.charAt(0).toUpperCase() : 'A'}
          </div>
          <div>
            <h2 className="text-xl font-extrabold text-red-500">Super Admin Panel</h2>
