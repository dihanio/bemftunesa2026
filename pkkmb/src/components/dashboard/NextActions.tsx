        ...
        <div className="space-y-3">
          {items.map((a) => {
            ...
            return (
              ...
              >
                <span
                  className={`mt-0.5 shrink-0 text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded-lg border ${
                    isQuiz
                ...
                <div className="shrink-0 w-full sm:w-auto sm:ml-auto">
                  {disabled ? (
                    <span className="inline-flex items-center justify-center w-full sm:w-auto px-3.5 py-2 rounded-lg text-xs font-semibold border border-white/10 bg-white/5 text-white/30">
                      {ctaLabel}
                    </span>
                  ) : ctaHref ? (
                    <Link
                      href={ctaHref}
                      className="inline-flex items-center justify-center w-full sm:w-auto px-3.5 py-2 rounded-lg text-xs font-bold bg-gold-500 hover:bg-gold-400 text-black transition-colors"
                    >
                      {ctaLabel}
                    </Link>
                  ) : (
