...
function LoginContent() {
  ...
  useEffect(() => {
    if (authenticated === "true") {
      // In real scenario we should check onboarding status, for now just go to dashboard
...
export default function LoginPage() {
  return (
    <main className="min-h-screen flex items-center justify-center relative overflow-hidden bg-black">
      ...
      >
        <div className="bg-white/[0.03] backdrop-blur-2xl border border-white/10 p-8 md:p-12 rounded-3xl shadow-2xl relative overflow-hidden group">
