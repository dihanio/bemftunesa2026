  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-5xl">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        {/* Verifikasi Dokumen */}
        <div className="bg-sage/5 rounded-2xl p-8 border border-sage/15">
          <ShieldCheck className="h-12 w-12 text-sage mb-4" />
        ...
        {/* Program Kerja */}
        <div className="rounded-2xl p-8 border border-sage/15 bg-slate-green/20 dark:bg-slate-green/10 flex flex-col justify-center">
          <CheckCircle2 className="h-12 w-12 text-sage mb-4" />
          ...
          <div className="w-full bg-sage/10 h-2 rounded-full overflow-hidden">
            <div className="bg-sage/50 h-full w-1/3 rounded-full" />
          </div>
