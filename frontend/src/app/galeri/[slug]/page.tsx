    ...
    <main className="pt-28 pb-16 px-6 max-w-6xl mx-auto w-full relative min-h-screen">
      ...
      <div className="mb-12">
        ...
        <div className="flex flex-wrap items-center gap-4 text-xs font-medium text-foreground/60 mb-6">
          <div className="flex items-center bg-slate-green/10 border border-sage/20 rounded-full px-3 py-1">
        ...
        {album.description && (
          <p className="text-sm text-foreground/80 leading-relaxed max-w-3xl glass-subtle p-5 rounded-2xl border border-sage/15">
            {album.description}
          </p>
        )}
      </div>
      ...
      {album.photos && album.photos.length > 0 ? (
          ...
          {album.photos.map((photo: any, index: number) => {
            ...
            return (
              <div 
                ...
                className="group relative aspect-square rounded-2xl overflow-hidden cursor-pointer bg-slate-green/20 border border-sage/15 hover:border-accent-gold/40 transition-all"
              >
                <Image 
                  src={imgUrl} 
                  alt={`Photo ${index + 1}`}
        ...
        <div className="text-center py-16 bg-slate-green/5 border border-sage/15 rounded-3xl">
