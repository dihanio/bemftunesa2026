...
export function AspirasiSection() {
  ...
  return (
    <section className="w-full max-w-6xl mx-auto py-12 px-6 relative z-10 bg-transparent">
      <div className="relative rounded-3xl overflow-hidden glass-subtle p-8 md:p-14 border border-white dark:border-accent-blue/20 shadow-2xl">
        

        <div className="absolute -right-32 -top-32 w-64 h-64 bg-accent-blue/5 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-stretch justify-between gap-12">
          ...
          <div className="w-full lg:w-7/12 text-center lg:text-left flex flex-col justify-center">
            <span className="inline-flex items-center gap-1.5 w-fit mx-auto lg:mx-0 px-3.5 py-1.5 rounded-full bg-accent-blue/10 border border-white dark:border-accent-blue/20 text-[10px] font-semibold text-accent-blue tracking-wide uppercase mb-6 shadow-sm">Kanal Advokasi Mahasiswa</span>
            <h2 className="text-3xl md:text-5xl font-extrabold text-foreground mb-5 leading-tight tracking-tight">
              ...
              <span className="text-accent-blue">Menentukan Arah</span>
            </h2>
          ...
          {/* Stats Box */}
          <div className="w-full lg:w-5/12 max-w-md mx-auto lg:mx-0 flex items-center">
            <div className="w-full glass-active rounded-2xl p-6 md:p-8 border border-white dark:border-accent-blue/25 shadow-md relative">
              <h3 className="text-xs font-bold text-foreground mb-6 uppercase tracking-wider border-b border-white dark:border-accent-blue/20 pb-3 flex items-center justify-between">
              ...
              <div className="space-y-5">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-extrabold text-accent-blue font-mono tracking-tight">
                    {loading ? "0" : resolvedAspirasi}
                  </span>
                </div>

                {/* Progress bar representing resolution rate */}
                <div className="pt-4 border-t border-white dark:border-accent-blue/10 flex flex-col gap-2">
                  ...
                  <div className="w-full h-2 rounded-full bg-accent-blue/10 overflow-hidden border border-white dark:border-accent-blue/10 p-[1px]">
                    <div
                      className="h-full rounded-full bg-accent-blue transition-all duration-1000 ease-out"
