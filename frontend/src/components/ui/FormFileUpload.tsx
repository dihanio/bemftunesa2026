...
export function FormFileUpload({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {fileName ? (
        <div className="flex items-center gap-3 px-4.5 py-3 rounded-xl bg-sage/5 border border-sage/15">
        ...
        <label
          className={`flex flex-col items-center justify-center gap-2 px-4 py-6 rounded-xl border border-dashed ${
            error ? "border-rose-500/50 bg-rose-500/5" : "border-sage/20 hover:border-sage/40 bg-slate-green/30"
